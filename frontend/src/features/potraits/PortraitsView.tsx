...
export const PortraitsView = ({ project, onUpdateProject }: PortraitsViewProps) => {
  ...
  const hasPortraits = characters.every(char => char.portraitUrl !== null);
  ...
  return (
    <div className="flex flex-col h-full animate-in fade-in duration-500">
      ...
      <div className="mt-12 pt-8 border-t border-gray-100 flex items-center justify-between">
        ...
        <button
          onClick={hasPortraits ? handleProceed : handleGeneratePortraits}
        ...
        >
          {isProcessing ? (
            <>
              ...
              {hasPortraits ? 'Proceeding...' : 'Generating Art...'}
            </>
          ) : (
            <>
              {hasPortraits ? 'Proceed to Chapters' : 'Generate Portraits'}
